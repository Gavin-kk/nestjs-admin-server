...
var AuthService = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        userInfo = _a.sent();
                        if (userInfo) {
                            throw new common_1.HttpException({ status: 400, msg: '用户已存在' }, 400);
                        }
                        _a.label = 2;
                    case 2:
                        _a.trys.push([2, 4, , 5]);
                    ...
                    case 4:
                        error_1 = _a.sent();
                        throw new common_1.HttpException({ status: 400, msg: '未知错误' }, 400);
    ...
    AuthService.prototype.findAllUser = function () {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    AuthService.prototype.removeUser = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.userRepository
